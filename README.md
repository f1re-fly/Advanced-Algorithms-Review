...
本仓库用于完成对 *Impossibility of Distributed Consensus with One Faulty Process* 的课程 review。当前成果已经收拢为一份统一主稿；专题笔记作为证明底稿保留，研究过程通过阅读日志和版本记录追踪。

## 直接阅读

- [FLP 不可能性结果：统一 Review](REVIEW.md) — 完整、连续的主稿
